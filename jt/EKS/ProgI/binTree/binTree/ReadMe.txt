========================================================================
    KONSOLENANWENDUNG: binTree-Projektübersicht
========================================================================

Diese binTree-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre binTree-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen binTree.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
